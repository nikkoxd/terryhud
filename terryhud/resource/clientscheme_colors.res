Scheme
{
	...
	Colors
	{
		...
		"G_Highlight"			"0 101 255 255" // Highlight color
		"G_White"				"255 255 255 255"
		"G_Black"				"0 0 0 255"
		"G_Red"					"230 0 0 255"
		"G_Shadow"				"0 48 121 168" // Shadow color
		"G_LightShadow"			"0 0 0 110"
		"G_Heal"				"127 224 74 255" // Heal color
		"G_Hit"					"0 101 255 255" // Hit color
		...
		"G_Overheal"			"122 174 255 255" // Overhealed health value color
		...
		"G_HeadsLabel"			"227 255 0 255" // Heads value icon color
		...
		"G_StickyIconColor"				"0 255 165 255" // Stickybomb icon color
		"G_CustomTargetID" 				"0 101 255 138" // Custom target id bg color
		...
		"G_TargetHealthValueShadow" 	"0 48 121 168" // Target ID health value shadow color
		...
		"G_Footer"					"23 23 23 100" // Menu footer color
		"G_DimmFooter"				"23 23 23 100" // Dimm Menu footer color
		"G_FooterText"				"255 255 255 255" // Footer text color
		"G_DimmFooterText"			"255 255 255 255" // Dimm Footer text color
		...
		"G_MainMenuPanel"			"23 23 23 100" // Main Menu panel color
		"G_MainMenuButton"			"224 229 237 255" // Main Menu button color
		"G_MainMenuButtonHover"		"0 101 255 255" // Main Menu hovered button color
		"G_MainMenuButtonFg"		"44 44 44 255" // Main Menu button text color
		...
		"G_BackpackItemBg"			"54 54 54 219" // Backpack item bg color
		"G_LoadoutItemBg"			"52 52 52 255" // Loadout item bg color
		"G_MenuBg"					"41 41 41 255" // Menu bg color
		"G_MenuText"				"199 209 220 255" // Menu text color
		"G_InputText"				"0 0 0 240" // Input text color
		"G_DimmInputText"			"0 0 0 100" // Dimm Input text color
		"G_DimmMenuText"			"199 209 220 120" // Dimm Menu text color
		"G_ItemDescriptionPanelBg"	"24 23 23 255" // Item description panel bg
		"G_ButtonBg"				"75 84 97 255" // Button bg color
		"G_ButtonText"				"189 206 231 255" // Button text color
		"G_ButtonHoverBg"			"82 151 255 255" // Button hover bg color
		"G_ButtonHoverText"			"255 255 255 255" // Button hover text color
		"G_ButtonSelectedBg"		"0 101 255 255" // Button selected bg color
		...
		"G_ItemMeterBg"				"0 101 255 255" // Item meter bg
		...
		"TFOrange"			"0 101 255 255" // Highlight color
		...
		"QualityColorrarity1"					"110 153 119 255" // IQC Genuine
		"QualityColorrarity2"					"141 131 75 255"
		"QualityColorrarity3"					"204 204 250 255"
		"QualityColorrarity4"					"176 0 255 255" // IQC Unusual
		"QualityColorVintage"					"131 146 172 255" // IQC Vintage
		"QualityColorUnique"					"0 101 255 255" // IQC Unique
		"QualityColorCommunity"					"117 184 76 255" // IQC Community
		"QualityColorDeveloper"					"255 122 216 255" // IQC Valve
		"QualityColorSelfMade"					"117 184 76 255" // IQC Community
		"QualityColorCustomized"				"71 98 145 255"
		"QualityColorStrange"					"255 116 0 255" // IQC Strange
		"QualityColorCompleted"					"134 80 172 255"
		"QualityColorHaunted"					"136 255 209 255" // IQC Haunted
		"QualityColorCollectors"				"159 31 31 255" // IQC Collectors
		"QualityColorPaintkitWeapon"			"250 250 250 255" // IQC PaintkitWeapon
		
		"DimmQualityColorNormal"				"255 255 255 100" // Dimm IQC Normal
		"DimmQualityColorrarity1"				"110 153 119 100" // Dimm IQC Genuine
		"DimmQualityColorrarity2"				"141 131 75 100"
		"DimmQualityColorrarity3"				"204 204 250 100"
		"DimmQualityColorrarity4"				"176 0 255 100" // Dimm IQC Unusual
		"DimmQualityColorVintage"				"131 146 172 100" // Dimm IQC Vintage
		"DimmQualityColorUnique"				"0 101 255 100" // Dimm IQC Unique
		"DimmQualityColorCommunity"				"117 184 76 100" // Dimm IQC Community
		"DimmQualityColorDeveloper"				"255 122 216 100" // Dimm IQC Valve
		"DimmQualityColorSelfMade"				"117 184 76 100" // Dimm IQC Community
		"DimmQualityColorCustomized"			"71 98 145 100"
		"DimmQualityColorStrange"				"255 116 0 100" // Dimm IQC Strange
		"DimmQualityColorCompleted"				"134 80 172 100"
		"DimmQualityColorHaunted"				"136 255 209 100" // Dimm IQC Haunted
		"DimmQualityColorCollectors"			"159 31 31 100" // Dimm IQC Collectors
		"DimmQualityColorPaintkitWeapon"			"250 250 250 100" // Dimm IQC PaintkitWeapon
		
		"ItemRarityDefault"						"131 126 119 255"
		"ItemRarityCommon"						"177 191 207 255" // IRC Common
		"ItemRarityUncommon"					"152 190 231 255" // IRC Uncommon
		"ItemRarityRare"						"142 122 228 255" // IRC Rare
		"ItemRarityMythical"					"177 134 255 255" // IRC Mythical
		"ItemRarityLegendary"					"244 146 255 255" // IRC Legendary
		"ItemRarityAncient"						"243 118 118 255" // IRC Ancient
		
		"DimmItemRarityDefault"						"131 126 119 100"
		"DimmItemRarityCommon"						"177 191 207 100" // Dimm IRC Common
		"DimmItemRarityUncommon"					"152 190 231 100" // Dimm IRC Uncommon
		"DimmItemRarityRare"						"142 122 228 100" // Dimm IRC Rare
		"DimmItemRarityMythical"					"177 134 255 100" // Dimm IRC Mythical
		"DimmItemRarityLegendary"					"244 146 255 100" // Dimm IRC Legendary
		"DimmItemRarityAncient"						"243 118 118 100" // Dimm IRC Ancient
	...
	BaseSettings
	{
		...
		Slider.NobColor				"0 101 255 255" // Highlight color
		Slider.TextColor			"199 209 220 255" // Menu text color
		Slider.TrackColor			"199 209 220 255" // Menu text color
		Slider.DisabledTextColor1	"199 209 220 120" // Dimm Menu text color
		Slider.DisabledTextColor2	"199 209 220 120" // Dimm Menu text color
