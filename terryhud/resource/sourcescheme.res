...
Scheme
{
	Colors
	{
		...
		"G_ActiveWindow"			"28 28 28 255" // Active window bg color
		"G_InctiveWindow"			"39 39 39 245" // Inactive window bg color
		"G_TitleBg"					"0 101 255 255" // Title bg color
		"G_TitleText"				"255 255 255 255" // Title text color
		"G_Highlight"				"0 101 255 255" // Highlight color
		"G_ConsoleBg"				"31 31 31 255" // Console bg color
		"G_ListBg"					"31 31 31 255" // List bg color
		"G_Border"					"0 0 0 255" // Border color
		...
		"G_DisabledText"			"255 255 255 66" // Disabled text color
		"G_ButtonBg"				"101 101 101 255" // Button bg color
		"G_ButtonText"				"255 255 255 255" // Button text color
		"G_ButtonHoverBg"			"0 101 255 255" // Button hover bg color
		"G_ButtonHoverText"			"255 255 255 255" // Button hover text color
		"G_InputBg"					"33 33 33 255" // Input bg color
	    ...
	    "QuickListBGSelected"       "0 101 255 255" // Highlight color
